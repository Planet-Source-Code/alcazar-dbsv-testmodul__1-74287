...
Private Sub CmdDel_Click()
 With TreeView1
  If vbYes = MsgBox("Delete selected subject?", vbExclamation + vbYesNo, MsgT) Then
   dbcon.Execute "DELETE FROM dbsv_main_fach WHERE fid='" & Val(.SelectedItem.Key) & "';"
   Log_Entry "D", "Deleted subject: " & .SelectedItem.Text, UsrInf.ID
