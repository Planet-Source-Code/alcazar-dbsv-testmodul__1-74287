...
Private Sub Text1_KeyPress(KeyAscii As Integer)
 If KeyAscii = 13 Then
  If Text1.Text <> "" Then
   ...
   rscon.Close
  End If
  MsgBox "Invalid Password", vbExclamation, MsgT
  Text1.Text = ""
  Text1.SetFocus
 End If
End Sub
...
Private Sub Command1_Click()
 If LCase$(Text1.Text) = LCase$(Text2.Text) Then
  MsgBox "Old and New Password must be different", vbExclamation, MsgT
  SetItem
  Exit Sub
 End If
 If IsValPw(UsrInf.Name, Text2.Text, Text3.Text) = True Then
  ...
  Log_Entry "D", "Changed Password: " & UsrInf.Name, UsrInf.ID
  Command2_Click
 Else
  SetItem
 End If
