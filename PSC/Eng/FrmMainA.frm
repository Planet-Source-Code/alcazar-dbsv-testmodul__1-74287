...
Private Sub Form_Unload(Cancel As Integer)
 If vbYes = MsgBox("Exit Administration?", vbExclamation + vbYesNo, MsgT) Then
  Log_Entry "A", "Logout Administration: " & UsrInf.Name, UsrInf.ID
  dbcon.Close
 Else
  Cancel = 1
 End If
...
Private Sub SetMainMnu()
 With ListView1.ListItems
  .Clear
  Set listX = .Add(, , "User", 2)
  Set listX = .Add(, , "Roles", 3)
  Set listX = .Add(, , "LogFile", 4)
  Set listX = .Add(, , "Programminfo", 5)
  Set listX = .Add(, , "Exit Admin", 1)
 End With
End Sub
