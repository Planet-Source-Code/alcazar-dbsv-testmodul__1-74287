...
Private Sub Form_Load()
 StatusBar1.Panels("uID").Text = "User:  " & UsrInf.Name & " ( " & UsrInf.RName & " )"
 SetMnu
End Sub
Private Sub Form_Unload(Cancel As Integer)
 If vbYes = MsgBox("Exit Program?", vbExclamation + vbYesNo, MsgT) Then
  Log_Entry "A", "Logout DBSV: " & UsrInf.Name, UsrInf.ID
  dbcon.Close
 Else
  Cancel = 1
 End If
...
Private Sub SetMainMnu()
 With ListView1.ListItems
  .Clear
  Set listX = .Add(, , "Change Password", 1)
  If Mid$(UsrInf.ACL, 1, 1) = "1" Then Set listX = .Add(, , "LogFile", 2)
  If Mid$(UsrInf.ACL, 2, 1) = "1" Then Set listX = .Add(, , "Subjects", 4)
  If Mid$(UsrInf.ACL, 3, 1) = "1" Then Set listX = .Add(, , "Classes", 5)
  If Mid$(UsrInf.ACL, 4, 1) = "1" Then Set listX = .Add(, , "TestEditor", 6)
  Set listX = .Add(, , "Programminfo", 7)
  Set listX = .Add(, , "Exit Program", 3)
 End With
End Sub
