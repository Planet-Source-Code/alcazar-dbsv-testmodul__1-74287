   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button1 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Key             =   "addr"
            Object.ToolTipText     =   "Create role"
            ImageIndex      =   3
         EndProperty
         BeginProperty Button2 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Enabled         =   0   'False
            Key             =   "editr"
            Object.ToolTipText     =   "Edit role"
            ImageIndex      =   4
         EndProperty
         BeginProperty Button3 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Enabled         =   0   'False
            Key             =   "delr"
            Object.ToolTipText     =   "Delete role"
            ImageIndex      =   5
         EndProperty
...
Private Sub mnudelr_Click()
 With TreeView1
  If vbYes = MsgBox("Delete role?", vbExclamation + vbYesNo, MsgT) Then
   rscon.Open "SELECT urole FROM dbsv_adm_user WHERE urole='" & Val(.SelectedItem.Key) & "';", dbcon, adOpenDynamic, adLockOptimistic
   If rscon.EOF = False Then
    rscon.Close
    MsgBox "Cannot delete role" & vbCrLf & "Reason: Role is assigned to users", vbExclamation, MsgT
   Else
    rscon.Close
    dbcon.Execute "DELETE FROM dbsv_adm_roles WHERE rid='" & Val(.SelectedItem.Key) & "';"
    Log_Entry "D", "Deleted role: " & .SelectedItem.Text, UsrInf.ID
