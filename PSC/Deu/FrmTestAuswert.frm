...
Begin VB.Form FrmTestAuswert 
   ...
   Begin VB.CommandButton CmdDel 
      ...
      Style           =   1  'Grafisch
      TabIndex        =   2
      ToolTipText     =   "Auswertung löschen"
      Top             =   2500
      Width           =   1320
   End
   ...
   Begin VB.Label Label1 
      Caption         =   "Testergebnisse: (Auswählen für Details)"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
...
Private Sub CmdDel_Click()
 If vbYes = MsgBox("Möchten Sie diese Auswertung wirklich löschen?", vbExclamation + vbYesNo, MsgT) Then
...
Function LoadFrm(vTest As Integer, vTestName As String)
 ...
 If UsrInf.Role = 2 Then
  ...
  If rscon.EOF = False Then
   ...
   Loop
  Else
   List1.AddItem "Keine Ergebnisse"
   List1.AddItem "für den Test vorhanden"
   List1.Enabled = False
  End If
