...
Begin VB.Form FrmTestEdit4 
   ...
   Caption         =   "TestEditor - Aufgaben editieren"
   ClientHeight    =   10425
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9915
...
Private Sub CheckCA_Click(Index As Integer)
 ...
 If y <> 0 Then
  MsgBox "Wenn diese Antwort richtig sein soll, sollte auch ein Antworttext eingegeben werden", vbExclamation, MsgT
...
Private Sub TxtScore_Change()
 If TxtScore.Text = "" Or Val(TxtScore.Text) = 0 Then
  MsgBox "Die Punktzahl sollte größer 0 sein...", vbExclamation, MsgT
  TxtScore.Text = 5
 End If
End Sub
...
Private Sub CmdSave_Click()
 ...
 If z = 0 Then
  ...
  Unload Me
 Else
  MsgBox "Sie haben nicht alle Felder angegeben." & vbCrLf & "Prüfen Sie folgendes:" & vbCrLf & "* Eingabe der Aufgabe" & vbCrLf & "* Eingabe von Antwortmöglichkeiten (bei Multiple Choice mind. 3)" & vbCrLf & "* Angabe der richtigen Antwort(en)", vbExclamation, MsgT
 End If
End Sub
