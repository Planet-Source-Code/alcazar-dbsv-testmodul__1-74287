...
Begin VB.Form prginfo 
   ...
   Begin VB.Frame Frminfo 
      ...
      Begin VB.Label Label6 
         Caption         =   "Erstellt mit: Visual Basic"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   12
            Charset         =   0
...
Private Sub Picture1_MouseUp(Button As Integer, Shift As Integer, x As Single, y As Single)
 If Button = 2 Then MsgBox "Netter Versuch, aber das EasterEgg ist nur in DBSV vorhanden...", vbExclamation, MsgT
End Sub
