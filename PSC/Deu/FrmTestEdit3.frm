...
Begin VB.Form FrmTestEdit3 
   ...
   Caption         =   "TestEditor - Aufgaben sortieren"
   ClientHeight    =   8220
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   10005
...
Private Sub CmdSave_Click()
 If List1.ListCount <> 0 Then
  MsgBox "In der linken Liste befinden sich noch Aufgaben zum sortieren.", vbExclamation, MsgT
 Else
