   ...
   Begin MSComctlLib.Toolbar Toolbar1 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button1 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Key             =   "addu"
            Object.ToolTipText     =   "Benutzer erstellen"
            ImageIndex      =   4
         EndProperty
         BeginProperty Button2 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Enabled         =   0   'False
            Key             =   "editu"
            Object.ToolTipText     =   "Benutzer editieren"
            ImageIndex      =   5
         EndProperty
         BeginProperty Button3 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Enabled         =   0   'False
            Key             =   "delu"
            Object.ToolTipText     =   "Benutzer entfernen"
            ImageIndex      =   6
         EndProperty
...
Private Sub mnudelu_Click()
 With TreeView1
  If vbYes = MsgBox("Benutzer wirklich entfernen?", vbExclamation + vbYesNo, MsgT) Then
   dbcon.Execute "DELETE FROM dbsv_adm_user WHERE uid='" & Val(.SelectedItem.Key) & "';"
   Log_Entry "D", "Benutzer entfernt: " & .SelectedItem.Text, UsrInf.ID
