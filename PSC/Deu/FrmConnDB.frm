...
Private Sub Form_Load()
 Label1.Caption = "Geben Sie die Verbindungsdaten zum Datenbankserver ein:" & vbCrLf & "(Der Benutzer muss Rechte auf diese Datenbank besitzen)"
End Sub
