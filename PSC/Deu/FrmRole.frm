...
Private Sub CmdAdd_Click()
 ...
 Else
  If roleid.Text <> roleid.Tag Then
   If DLLSec.ValID(roleid.Text, "dbsv_adm_roles", "rname") = False Then Exit Sub
 ...
 End If
 Log_Entry "D", "Rolle editiert: " & roleid.Text, UsrInf.ID
 CmdClose_Click
End Sub
...
Private Sub SetTree()
 With TreeView1.Nodes
  ...
  Set nodX = .Add("root", tvwChild, "filemnu", "Datei", 2)
  Set nodX = .Add("root", tvwChild, "datamnu", "Schuldaten", 2)
  Set nodX = .Add("root", tvwChild, "modmnu", "Module", 2)
  nodX.EnsureVisible
  Set nodX = .Add("filemnu", tvwChild, "1x", "LogDatei", 3)
  nodX.EnsureVisible
  Set nodX = .Add("datamnu", tvwChild, "2x", "Fächer", 4)
  Set nodX = .Add("datamnu", tvwChild, "3x", "Klassendaten", 5)
  nodX.EnsureVisible
