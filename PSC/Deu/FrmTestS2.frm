...
Private Const MsgText As String = "Du solltest eine gültige Antwort auf die Aufgabe eingeben"
Private Sub Timer1_Timer()
 If Val(LblStd.Caption) = 0 And Val(LblMin.Caption) = 0 And Val(LblSec.Caption) = 0 Then
  Timer1.Enabled = False
  MsgBox "Die Zeit ist abgelaufen, der Test wird beendet!", vbExclamation, MsgT
  EndTest 1
  Exit Sub
 End If
...
Private Sub CmdCancel_Click()
 If vbYes = MsgBox("Test wirklich beenden?" & vbCrLf & "Test wird als ""Nicht bestanden"" gewertet!", vbExclamation + vbYesNo, MsgT) Then
  Timer1.Enabled = False
  ...
  If CmdCancel.Tag = False Then
   ...
   Log_Entry "D", "Test abgebrochen: " & Mid$(LblTest.Caption, 8), UsrInf.ID
  End If
  Unload Me
 End If
End Sub
Private Sub CmdNext_Click()
 If LblCurA.Caption = gaufg Then
  MsgBox """Nächste Aufgabe"" wählen nicht möglich" & vbCrLf & "Dies ist die letzte Aufgabe", vbExclamation, MsgT
 Else
...
Private Sub CmdEnd_Click()
 If vbYes = MsgBox("Möchtest Du den Test beenden und bewerten lassen?" & vbCrLf & "Nicht beantwortete Fragen werden als ""falsch"" gewertet!", vbExclamation + vbYesNo, MsgT) Then EndTest 0
End Sub
...
Private Sub EndTest(Mode As Integer)
 ...
 If CmdCancel.Tag = False Then
  ...
  rscon.Close
  Log_Entry "D", "Test-Teilnahme: " & Mid$(LblTest.Caption, 8), UsrInf.ID
  Me.Hide
...
Function LoadFrm(vTest As Integer, vTestName As String, vFach As Integer, vMode As Boolean)
 ...
 With FrmTestIntro
  ...
  .Label2.Caption = "Dieser Test enthält " & gaufg & " Aufgaben und kann " & mlimit & "x durchgeführt werden."
  If TestInf.TimeL = 0 Then
   .Label3.Caption = "Dieser Test hat kein Zeitlimit."
  Else
   .Label3.Caption = "Dieser Test hat ein Zeitlimit von " & TestInf.TimeL & " Minuten."
  End If
  .Show vbModal
 End With
